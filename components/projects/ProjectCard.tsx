...
export function ProjectCard({ project, visitLabel }: ProjectCardProps) {
  ...
  return (
    ...
    >
      <div className="pointer-events-none absolute inset-0 rounded-[26px] border border-sky-200/0 opacity-0 transition-all duration-500 ease-in-out md:rounded-[32px] group-hover:border-sky-200/35 group-hover:opacity-100 group-hover:shadow-[0_0_0_1px_rgba(125,211,252,0.18),0_0_42px_rgba(56,189,248,0.18)]" />
      <div className="absolute inset-0 bg-gradient-to-b from-sky-300/8 via-transparent to-slate-950/70 opacity-100 md:opacity-0 md:transition md:duration-500 md:ease-in-out md:group-hover:opacity-100" />
